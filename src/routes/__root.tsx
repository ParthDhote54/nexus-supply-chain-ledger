...
export const Route = createRootRoute({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Blockchain-based semiconductor supply chain — chip passports, lifecycle tracking, fraud detection." },
      { name: "author", content: "NEXUS Labs" },
      { property: "og:title", content: "NEXUS Semiconductor Ledger" },
      { property: "og:description", content: "Track every chip from foundry to recycler with on-chain verification." },
